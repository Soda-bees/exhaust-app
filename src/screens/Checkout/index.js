...
export default function Checkout({navigation, route}) {
  ...
  useEffect(() => {
    ...
    const selectedAddress = userData.shippingAddress.filter(
        ...
        <View
          ...
          <View style={styles.mainContainer}>
            <View style={styles.topTextView}>
              ...
              <TouchableOpacity
                style={Platform.OS == 'ios' && styles.addressViewIOS}
                onPress={() =>
                  navigation.navigate(
                    selectedAddress
                      ? 'AddShippingAddress'
                ...
                <Text
                  style={
                    Platform.OS == 'android'
                      ? styles.topTextSty2
                      : styles.topTextSty2IOS
                  }>
                  {selectedAddress ? 'Add new address' : 'Select address'}
                </Text>
              </TouchableOpacity>
            </View>
            {selectedAddress && (
            ...
            <View style={styles.topTextView}>
              ...
              <TouchableOpacity
                ...
                <Text
                  ...
                  {selectedCard ? 'Add new card' : 'Select card'}
                </Text>
              </TouchableOpacity>
            </View>
            {selectedCard && (
              <View style={styles.MainCartView2}>
                <View style={styles.row}>
                  ...
                  <Text style={styles.firstCartText}>{`**** **** **** ${String(
                    selectedCard.cardNumber,
                  ).substring(
                    String(selectedCard.cardNumber).length - 4,
                  )}`}</Text>
                </View>
                <TouchableOpacity
          ...
          <View style={Platform.OS == 'ios' && styles.marginBtm}>
            ...
            <View style={styles.pricesStyling2}>
              <Text
                style={
                  styles.priceText2
                }>{`Total(${userData?.cart?.length} items):`}</Text>
            ...
            {loader ? (
              ...
              <View style={Platform.OS == 'android' ? styles.bottomBtnDisable : styles.bottomBtnDisableIOS}>
                <Text style={styles.bottomBtnText}>Submit Order</Text>
                <Image
                  source={images.forwardIcon2}
          ...
          <View style={styles.modalBody}>
            <View style={styles.modalMainView}>
              ...
              <Text style={styles.modalHeading}>{`${
                editCard ? 'Update card' : 'Add New Card'
              }`}</Text>
              ...
              {addCardLoader ? (
                ...
                <TouchableOpacity
                  onPress={() => {
                    editCard ? handleEditCard() : handleAddCard();
                  }}
                  style={Platform.OS == 'android' ? styles.modalBottomBtn : styles.modalBottomBtnIOS}> 
